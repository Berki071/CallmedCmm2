...
class ShowFilesMediaTmAdapter(val context: Context, val list: MutableList<DataForRecyFiles>, val listener: ShowFilesMediaTmHolder.ShowFilesMediaTmHolderListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
//        val view = LayoutInflater.from(context).inflate(R.layout.item_show_files_media, parent, false)
//        val bindingItem = ItemShowFilesMediaBinding.bind(view)
//        return ShowFilesMediaTmHolder(bindingItem, listener)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when(list[position].type){
            ...
            DataForRecyFiles.DataForRecyFilesType.FILE-> {
                (holder as ShowFilesMediaTmHolder).onBind(list[position])
            }
            else -> {}
        }
    }
