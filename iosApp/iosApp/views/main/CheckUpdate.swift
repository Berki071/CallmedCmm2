...
class CheckUpdate: NSObject {
    ...
    static let appStoreId = "1660191573" // Id Example
    ...
    private func getUrl(from identifier: String) -> String {
        ...
        let appStoreURL = "http://itunes.apple.com/ru/lookup?bundleId=\(identifier)"
...
extension UIViewController {
    @objc fileprivate func showAppUpdateAlert(version : String, force: Bool, appURL: String, isTestFlight: Bool) {
        ...
        let alertTitle = "Доступна новая версия"
        let alertMessage = "Для продолжения работы необходимо обновить приложение.\nНажмите кнопку ОБНОВИТЬ"
