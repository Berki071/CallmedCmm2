...
struct Tabs: View {
    ...
    var body: some View {
                        ...
                        ForEach(0 ..< tabs.count, id: \.self) { row in
                            Button(action: {
                                ...
                                VStack(spacing: 0) {
                                    ...
                                    // Bar Indicator
                                    Rectangle().fill(selectedTab == row ? Color(#colorLiteral(red: 0.6196078431, green: 0.1098039216, blue: 0.2509803922, alpha: 1)) : Color.clear)
                                        .frame(height: 3)
                                }.fixedSize()
                            })
        ...
        .frame(height: 55)
        .onAppear(perform: {
            UIScrollView.appearance().backgroundColor = UIColor(Color("light_gray"))
