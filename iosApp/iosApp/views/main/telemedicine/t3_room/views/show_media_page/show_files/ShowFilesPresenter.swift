...
class ShowFilesPresenter: ObservableObject {
    ...
    func getData(){
        ...
        do {
            ...
            let allFilesPngURL = directoryContents.filter{ $0.pathExtension == "pdf" }  // во внутренню папку все сохраняютсяв пнг
